...
class DefaultParametersTest extends PHPUnit
{
    ...
    {
        $ruleset = new DefaultParameters(Chips::fromAmount(50), null, 9);
    ...
    {
        $ruleset = new DefaultParameters(Chips::fromAmount(1), Chips::fromAmount(1), 2);
    ...
    {
        $ruleset = new DefaultParameters(Chips::fromAmount(20), Chips::fromAmount(0), 2);
    ...
    {
        new DefaultParameters(Chips::fromAmount(1), Chips::fromAmount(1), 1);
    }
    ...
    {
        new DefaultParameters(Chips::fromAmount(1), Chips::fromAmount(2), 1);
    }
}
